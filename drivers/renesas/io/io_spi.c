...
{
	int result;
	const io_spi_flash_spec_t *block_spec = (io_spi_flash_spec_t *)spec;
...
int register_io_dev_spi_flash(const io_dev_connector_t **dev_con)
{
	int result;
	assert(dev_con != NULL);
