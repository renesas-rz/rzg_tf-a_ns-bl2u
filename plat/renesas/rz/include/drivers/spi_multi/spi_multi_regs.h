...
#define SPI_MULTI_BASE				RZG2L_SPIMULT_BASE
#define SPI_MULTI_BUF				RZG2L_SPIMULT_WBUF_BASE
#define SPI_MULTI_BUF_SIZE			(0x00000100)
...
#define SMCR_SPIE_NOT_TRANSFER				(0 << 0)
#define SMCR_SPIE_TRANSFER_ENABLE			(1 << 0)
#define SMCR_SPIWE_DISABLE					(0 << 1)
#define SMCR_SPIWE_ENABLE					(1 << 1)
#define SMCR_SPIRE_DISABLE					(0 << 2)
#define SMCR_SPIRE_ENABLE					(1 << 2)
#define SMCR_SSLKP_NEGATED					(0 << 8)
#define SMCR_SSLKP_MAINTAINED				(1 << 8)
...
#define SMENR_OCDE_DISABLED					(0 << 12)
#define SMENR_OCDE_ENABLED					(1 << 12)
#define SMENR_CDE_DISABLED					(0 << 14)
#define SMENR_CDE_ENABLED					(1 << 14)
#define SMENR_DME_DISABLED					(0 << 15)
#define SMENR_DME_ENABLED					(1 << 15)
...
#define SMDRENR_SPIDRE_SDR_TRANS			(0 << 0)
#define SMDRENR_SPIDRE_DDR_TRANS			(1 << 0)
#define SMDRENR_OPDRE_SDR_TRANS				(0 << 4)
#define SMDRENR_OPDRE_DDR_TRANS				(1 << 4)
#define SMDRENR_ADDRE_SDR_TRANS				(0 << 8)
#define SMDRENR_ADDRE_DDR_TRANS				(1 << 8)
...
#define PHYCNT_CAL_PERFOMED					(U(1) << 31)
...
#define PHYOFFSET2_OCTTMG_WRITE_BUFFER		(0 << 8)
...
#define SMCMR_CMD_PAGE_PROGRAM						(0x02)
#define SMCMR_CMD_READ_STATUS_REG					(0x05)
#define SMCMR_CMD_WRITE_ENABLE						(0x06)
#define SMCMR_CMD_BLOCK_ERASE						(0x20)

#define STATUS_REGISTER_S0_READY					(0 << 0)
#define STATUS_REGISTER_S0_BUSY						(1 << 0)
#define STATUS_REGISTER_S0_MASK						(1 << 0)
